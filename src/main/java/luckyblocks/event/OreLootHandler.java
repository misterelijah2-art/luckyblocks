...
public class OreLootHandler {
    ...
    // 10% chance to drop the lucky block from its matching vanilla ore
    ...
    public static void register() {
        ...
        // Amethyst — uses amethyst cluster since there's no "amethyst ore"
        injectDrop("minecraft:blocks/amethyst_cluster", ModBlocks.AMETHYST_LUCKY_BLOCK.asItem());
    }

    private static void injectDrop(String tableId, net.minecraft.world.item.Item item) {
